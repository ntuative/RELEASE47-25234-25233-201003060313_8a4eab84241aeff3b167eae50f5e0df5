package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2350:String = "catalog.page.club";
      
      private var var_2384:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","HabboNavigatorCom_hh_room_erics_png") == "true";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2350,true);
      }
