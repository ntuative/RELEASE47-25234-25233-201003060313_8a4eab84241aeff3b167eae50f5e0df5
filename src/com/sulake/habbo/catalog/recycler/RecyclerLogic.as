package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_769:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1471)
         {
            case RecyclerStatusMessageEvent.const_1392:
               ...
               break;
            case RecyclerStatusMessageEvent.const_816:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1335:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1471 != RecyclerStatusMessageEvent.const_816;
      }
      
      private function get statusActive() : Boolean
      {
         return var_257 != const_769;
      }
      ...
      {
         return active && var_257 == const_347;
      }
