package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1244:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_821:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1375 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1375) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_842);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1159) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1244;
            _loc2_.init();
         }
         var_1244.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1244.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_842);
      }
