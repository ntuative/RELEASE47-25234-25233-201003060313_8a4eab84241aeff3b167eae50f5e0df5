package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1075 != null)
         {
            var_1075.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1076 != null)
         {
            var_1076.removeEventListener(WindowKeyboardEvent.const_156,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1075 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1075 != null)
         {
            var_1075.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1076 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1076 != null)
         {
            var_1076.addEventListener(WindowKeyboardEvent.const_156,windowKeyEventProcessor);
         }
      }
