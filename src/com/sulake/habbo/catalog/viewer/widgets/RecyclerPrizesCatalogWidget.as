package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1820:XML;
      
      private var var_316:IGridItem;
      
      private var var_1381:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_821:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_665.length)
         {
            createLevelItem(var_665[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_821 = new PrizeViewer();
         var_607 = new Map();
         var_665 = recycler.getPrizeTable();
         if(var_665 == null)
         {
            return;
         }
         ...
         var_1820 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_665[0].prizes.length > 0)
         {
            select(var_665[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1820) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1381) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_821.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
