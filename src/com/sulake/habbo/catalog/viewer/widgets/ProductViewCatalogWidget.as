package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1442:Point;
      
      private var var_1785:Array;
      
      private var var_555:IItemGridWindow;
      
      private var var_85:IBitmapWrapperWindow;
      
      private var var_1364:ITextWindow;
      
      private var var_1192:IScrollbarWindow;
      
      protected var var_1381:XML;
      
      private var var_1193:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_555 != null)
         {
            ...
            var_555.destroyGridItems();
         }
         if(var_1192 != null)
         {
            var_1192.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1364.text = "${" + _loc3_.name + "}";
            var_1363.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1364.text = "${" + _loc2_.localizationId + "}";
            var_1363.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_478:
                  _loc4_ = var_1193.clone();
                  if(var_555 != null)
                  {
                     var_555.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_555,var_1192,var_1381);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_232:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_53);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_48,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_333,AvatarAction.const_738);
                              _loc13_.appendAction(AvatarAction.const_517,_loc6_.productClassId);
      ...
      {
         var_1364 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1363 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1442 = new Point(var_85.x,var_85.y);
         var_555 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1192 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_555 == null)
         {
         ...
         var_1193 = _loc2_.content as BitmapData;
