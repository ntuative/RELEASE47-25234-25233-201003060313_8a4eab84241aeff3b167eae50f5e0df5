package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_922:MarketPlaceOfferData;
      
      private const const_1439:int = 1;
      
      private const const_1650:int = 40;
      
      private var var_525:IWindowContainer;
      
      private const const_1438:int = 2;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1438,_loc2_.length);
         if(!var_437)
         {
            var_437 = new Timer(25);
            var_437.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_921 = 0;
         populateList();
         var_437.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_607)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1439);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_438.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_437)
         {
            var_437.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_437 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_921 >= var_607.length)
            {
               return true;
            }
            addListItem(var_607.getWithIndex(var_921));
            ++var_921;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_922.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_438));
            _loc7_.selection = 0;
         }
      }
