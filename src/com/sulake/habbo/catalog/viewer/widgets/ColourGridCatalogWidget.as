package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1301 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_316 = null;
         for each(_loc1_ in var_1302)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1301) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_820.width,var_820.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_662.width,var_662.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_662,var_662.rect,new Point(0,0),null,null,true);
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         var_662 = _loc4_.content as BitmapData;
         populateColourGrid();
