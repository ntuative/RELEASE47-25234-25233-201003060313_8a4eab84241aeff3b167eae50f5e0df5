package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_579[var_1025] as Array;
      ...
      {
         var _loc2_:Offer = var_579[var_1025][var_1949];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_446 || _loc1_.pricingModel == Offer.const_468)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_579)
         {
            if(var_1949 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1949] as Offer;
               method_5(_loc3_);
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1025 = var_937.getGridItemIndex(param1.view);
