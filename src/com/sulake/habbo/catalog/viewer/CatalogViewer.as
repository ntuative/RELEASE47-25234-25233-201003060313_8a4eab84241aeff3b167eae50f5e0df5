package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1472:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_569 != null)
         {
            if(var_569.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_569.window);
            var_569.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1472);
         var_569 = _loc5_;
      ...
      {
         return var_569.dispatchWidgetEvent(param1);
      }
