package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1631:uint = 4.291613146E9;
      ...
      private const const_1630:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_853;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_853,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_569,var_80,var_1041);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_853);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_582[var_195]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_583[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_569,var_80,var_1041,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_145:
               ...
               if(var_2034 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_210)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1630)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2034 = _loc3_.text;
               break;
            case WindowMouseEvent.const_51:
               showSuggestions(false);
               if(var_1265)
               ...
               break;
            case WindowKeyboardEvent.const_611:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1401 = _loc1_.stuffTypes;
            var_582 = _loc1_.boxTypes;
            var_583 = _loc1_.ribbonTypes;
            var_853 = var_1401[0];
            var_195 = var_582[0];
            _ribbonIndex = var_583[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_494 == null)
         {
            var_494 = createWindow("suggestion_list_item") as IWindowContainer;
            var_494.procedure = suggestionsEventHandler;
         }
         if(var_226 == null || var_494 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_226.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_494.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
