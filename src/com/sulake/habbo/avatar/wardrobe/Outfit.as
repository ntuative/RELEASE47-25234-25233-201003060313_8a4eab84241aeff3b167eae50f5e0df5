package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1483 = var_12.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_100);
         var_1483.setDirection(AvatarSetType.const_39,int(FigureData.const_820));
         _image = var_1483.getImage(AvatarSetType.const_39);
         _view.udpate(_image);
      }
