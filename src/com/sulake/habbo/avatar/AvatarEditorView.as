package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1591:IWindowContainer;
      
      public static var var_1365:IWindowContainer;
      ...
      private var var_1443:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_469:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1365 == null)
         {
            ...
            var_1365 = var_12.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1591 == null)
         {
            _loc5_ = var_12.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1591 = var_12.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_469)
         {
            ...
            var_469 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_469.procedure = stripClubDialogEventProc;
            var_469.center();
         }
         else
         {
            var_469.visible = true;
            var_469.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1443 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_745 != null)
         {
            toggleCategoryView(var_745,true);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_745 = param1;
         var_1443.setSelected(var_1443.getSelectableByName(param1));
         _window.invalidate();
      }
