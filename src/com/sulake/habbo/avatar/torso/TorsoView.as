package com.sulake.habbo.avatar.torso
{
   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function TorsoView(param1:TorsoModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_152,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.SHIRT,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.CHEST_ACCESSORIES,param2,param3);
