package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1582:Number = 1;
      
      private var _b:uint;
      
      private var var_1580:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1581,var_1580,var_1582,_alphaMultiplier);
         var_964 = generatePaletteMapForGrayscale(var_1717,var_1715);
      }
      
      public function get reds() : Array
      {
         return var_964.getValue("reds") as Array;
      }
      ...
      {
         return var_964.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_964.getValue("greens") as Array;
      }
      ...
      {
         return var_964.getValue("alphas") as Array;
      }
