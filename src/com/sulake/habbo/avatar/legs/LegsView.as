package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_175,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_136,param2,param3);
