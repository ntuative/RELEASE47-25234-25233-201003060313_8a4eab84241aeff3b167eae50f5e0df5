package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1128:String = AvatarSetType.const_39;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_203 == null)
         {
            var_203 = AvatarScaleType.const_53;
         }
         ...
         var_605 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_605.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_1090;
         }
         var_125 = new AvatarImageCache(var_74,this,_assets,var_203);
         setDirection(const_1128,const_1127);
         var_204 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1340;
         if(param2 < AvatarDirectionAngle.const_1245)
         {
            param2 = AvatarDirectionAngle.const_522 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_522)
         {
            param2 -= NaN;
         }
         if(var_743 == AvatarType.PET && param1 == AvatarSetType.const_48)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_74.sortActions(var_204);
         if(_loc1_ == null)
         {
            var_606 = new Array(0,0,0);
         }
         else
         {
            var_606 = var_74.getCanvasOffsets(_loc1_,var_203,var_95);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1340 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_522 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_681)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_405)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_401)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_74.getPartColor(var_605,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_74.getCanvas(var_203,var_179.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_74.getBodyParts(param1,var_179.definition,var_95);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_743 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_74.getParts(_loc9_,var_605,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_203 == AvatarScaleType.const_100)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_74.getPartActionOffset(getSubType(),var_203,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_74.getCanvas(var_203,var_179.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_74.getBodyParts(param1,var_179.definition,var_95);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_486);
            if(_loc8_ != null)
            {
               ...
               if(var_743 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_74.getParts(_loc7_,var_605,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_486);
                     _loc19_ = var_95;
                     _loc20_ = 1;
                     switch(var_95)
                     {
                     ...
                     _loc21_ = var_74.getPartActionOffset(getSubType(),var_203,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_179 = new ActiveActionData(AvatarAction.const_874);
         var_179.definition = var_74.getActionDefinition(const_1126);
      ...
      {
         return var_74.getBodyPartData(param1.animation.id,var_486,param1.id);
      }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            case AvatarAction.const_512:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_812:
                     ...
                     break;
                  default:
                     method_2("appendAction() >> UNKNOWN POSTURE TYPE: " + _loc3_);
               }
               break;
            ...
            case AvatarAction.const_1024:
               ...
               break;
            default:
               method_2("appendAction() >> UNKNOWN ACTION TYPE: " + param1);
         }
         return true;
      }
