package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1618:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_992:BitmapData;
      
      private const const_1619:int = 13421772;
      
      private var var_775:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1415 = Math.max(var_1415,_loc7_.colorLayerIndex);
            }
         }
      ...
      private function analyzeLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_798 + "_" + FigureData.const_275;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_775.width,var_775.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_798 + "_" + FigureData.const_275;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1414 && _loc2_.colorLayerIndex > 0)
               {
