package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIndex(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(var_63.length <= _selectedColorLayerIndex)
         {
            return null;
         }
         if(!_palette)
         ...
         var_63[_selectedColorLayerIndex] = param1;
      ...
      {
         return _data[var_657] as AvatarEditorGridPartItem;
      }
      ...
      public function selectItemIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_657 >= 0 && _data.length > var_657)
         {
            _loc3_ = _data[var_657];
      ...
      public function selectColorLayerIndex(param1:int) : void
      {
         ...
         while(var_63.length <= param1)
         {
            var_63.push(-1);
         }
         selectColorIndex(var_63[_selectedColorLayerIndex]);
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_63 = new Array(param1.length);
         var _loc3_:int = 0;
