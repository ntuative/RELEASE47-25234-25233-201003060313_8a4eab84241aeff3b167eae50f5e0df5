package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_679.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1243)
         {
            ...
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_954,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_48,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_324,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1376,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_793,new WardrobeModel(this));
            var_1243 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1014 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1014 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1591.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
                  if(param2 != FigureData.const_58)
                  {
                     _loc18_ = 0;
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1365.clone() as IWindowContainer,param1,null,null,false);
                  _loc6_.iconImage = _loc20_;
                  _loc3_.push(_loc6_);
               }
            }
            _loc15_ = param2 != FigureData.const_58;
            _loc16_ = Boolean(_loc9_ == "1");
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1277)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1014 >= _loc5_.clubLevel))
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1365.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_793);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_679.getPalette(param1);
      }
      ...
      {
         var_679 = var_551.getFigureData(AvatarType.const_80);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_551 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_221 == null)
            {
               var_221 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_221.addChild(_view.window);
               var_221.center();
               var_221.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_954);
         if(var_573 != null)
         {
            var_573.getWardrobe();
         }
