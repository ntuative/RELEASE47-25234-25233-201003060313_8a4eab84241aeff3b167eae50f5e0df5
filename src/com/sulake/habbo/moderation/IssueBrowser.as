package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1544:IIssueBrowserView;
      
      private const const_1652:String = "closed_issues";
      ...
      private var var_1545:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_237 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_237.numTabItems)
            {
               _loc5_ = var_237.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_237.selector.getSelectableByName("open_issues");
         var_237.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_362.view.width = var_237.container.width;
         var_362.view.height = var_237.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1645:
               if(var_1544 == null)
               {
                  var_1544 = new MyIssuesView(issueManager,this,var_237.container);
               }
               return var_1544;
            case const_1647:
               if(var_1546 == null)
               {
                  var_1546 = new OpenIssuesView(issueManager,this,var_237.container);
               }
               return var_1546;
            case const_1646:
               if(var_1545 == null)
               {
                  var_1545 = new PickedIssuesView(issueManager,this,var_237.container);
               }
               return var_1545;
            default:
               return null;
