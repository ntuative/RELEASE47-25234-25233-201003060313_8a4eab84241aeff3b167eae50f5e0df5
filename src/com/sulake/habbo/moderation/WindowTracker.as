package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_546:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1162:int = 7;
      
      public static const const_897:int = 3;
      
      public static const const_1318:int = 8;
      
      public static const const_910:int = 5;
      ...
      private var var_1390:Dictionary;
      
      public function WindowTracker()
      {
         var_1390 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1390[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1390[param1] = _loc2_;
         }
         return _loc2_;
      }
