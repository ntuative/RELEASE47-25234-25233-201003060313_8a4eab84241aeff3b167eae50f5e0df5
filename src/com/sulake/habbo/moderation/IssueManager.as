package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_854:String = "issue_bundle_open";
      
      public static const const_516:String = "issue_bundle_my";
      
      public static const const_973:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_134 = new Map();
         var_837 = new Map();
         var_568 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_674 = [];
         var_838 = [];
         var_1010 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1010.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_837.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_837.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1226)
         {
            var_157.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_134)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_837.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_837.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_155)
         {
            ...
            _loc8_ = var_838.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1010.remove(param1);
         var_1010.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_1010.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_934);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_837.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_134.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_424 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
