package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_783:int = 31536000;
      
      private static const const_782:int = 86400;
      
      private static const const_781:int = 3600;
      
      private static const const_780:int = 60;
      ...
      {
         if(param1 < 2 * const_780)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_781)
         {
            return Math.round(param1 / const_780) + " mins ago";
         }
         if(param1 < 2 * const_782)
         {
            return Math.round(param1 / const_781) + " hours ago";
         }
         if(param1 < 2 * const_783)
         {
            return Math.round(param1 / const_782) + " days ago";
         }
         return Math.round(param1 / const_783) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_910,_data.userId),_callerFrame,var_1047,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_867.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_867.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1198),_callerFrame,var_1047,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1047,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1198),_callerFrame,var_1047,false,true);
      }
