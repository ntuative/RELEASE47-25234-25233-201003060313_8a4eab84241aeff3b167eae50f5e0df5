package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_381:UserInfoCtrl;
      
      private var var_57:ModerationManager;
      
      private var var_960:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.releaseBundle(var_112.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_381 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_960 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_381.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_112.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_960.load(_loc4_,var_112.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_112.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_57.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_57,WindowTracker.const_897,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_57 != null && false && var_112 != null)
         {
            var_57.issueManager.removeHandler(var_112.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_381 = new UserInfoCtrl(_window,var_57,_loc3_.message);
            var_381.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_112.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_57.issueManager.closeBundle(var_112.id,3);
         checkAutoHandling();
         dispose();
      }
