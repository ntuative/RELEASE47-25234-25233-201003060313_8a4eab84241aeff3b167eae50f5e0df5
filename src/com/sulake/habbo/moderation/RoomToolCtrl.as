package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1033:ICheckBoxWindow;
      ...
      private var var_840:IDropMenuWindow;
      
      private var var_695:ICheckBoxWindow;
      
      private var var_53:IFrameWindow;
      
      private var var_1032:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_546,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_386);
         if(param1.flatId != var_386)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_386);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1393,_loc2_,var_395.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1033.isSelected,var_1032.isSelected,var_695.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1285);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1215);
      }
      ...
      public function populate() : void
      {
         ...
         var_840 = IDropMenuWindow(var_53.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_840);
         var_840.procedure = onSelectTemplate;
         var_695 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1033 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1032 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_386));
         Logger.log("BEGINNING TO SHOW: " + var_386);
      }
   }
}
