   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_151,onFigureUpdate);
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_151,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_650);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_332);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_895);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_961);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_327)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_381)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_977)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_549);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_209)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_219)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_624);
                  ...
                  _loc25_ = _container.sessionDataManager.method_1("fuse_trade");
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1209;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_841;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_848;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1222);
               }
               else
               {
               ...
               _loc18_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_53);
               if(_loc18_ != null)
               {
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_53);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_588.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_53);
            var_588.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_624);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_132];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_374);
         _loc1_.push(RoomWidgetUserActionMessage.const_631);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_586);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_608);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_736);
         _loc1_.push(RoomWidgetUserActionMessage.const_403);
         _loc1_.push(RoomWidgetUserActionMessage.const_679);
         _loc1_.push(RoomWidgetUserActionMessage.const_648);
         _loc1_.push(RoomWidgetUserActionMessage.const_1303);
         _loc1_.push(RoomWidgetPetCommandMessage.const_729);
         _loc1_.push(RoomWidgetPetCommandMessage.const_509);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_132:
      ...
      public function dispose() : void
      {
         ...
         if(var_588 != null)
         {
            _loc1_ = var_588.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_588.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_403)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_556:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_804,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_629:
               ...
               break;
            case RoomWidgetUserActionMessage.const_374:
               _container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_631:
            ...
            case RoomWidgetFurniActionMessage.const_254:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_586:
            ...
            case RoomWidgetUserActionMessage.const_439:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_608:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_736:
            ...
            case RoomWidgetUserActionMessage.const_403:
               ...
               break;
            case RoomWidgetUserActionMessage.const_679:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_509:
