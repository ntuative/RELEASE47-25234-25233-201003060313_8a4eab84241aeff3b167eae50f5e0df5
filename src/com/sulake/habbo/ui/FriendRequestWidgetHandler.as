package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_318;
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFriendRequestMessage.const_654);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_559);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_111:
               ...
               break;
            case FriendRequestEvent.const_55:
            case FriendRequestEvent.const_259:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_561:
               ...
               if(_loc4_)
               {
                  _loc5_ = _container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_35,_container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_654:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_559:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_111);
         _loc1_.push(FriendRequestEvent.const_55);
         _loc1_.push(FriendRequestEvent.const_259);
         return _loc1_;
      }
