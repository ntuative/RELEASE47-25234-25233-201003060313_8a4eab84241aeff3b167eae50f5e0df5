package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_669,RoomWidgetStickieSendUpdateMessage.const_734,RoomWidgetStickieSendUpdateMessage.const_413];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_669:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_942);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_413:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_734:
