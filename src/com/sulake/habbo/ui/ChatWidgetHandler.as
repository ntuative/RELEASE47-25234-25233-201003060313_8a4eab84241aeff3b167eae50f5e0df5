package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_488:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_490 != null)
         {
            ...
            {
               _loc2_ = var_490.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_490.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_697.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_327:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_100);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_100);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_490.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_697.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_646,RoomWidgetChatSelectAvatarMessage.const_622];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_646:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 25234-25233-201003060242");
                              processEvent(_loc10_ as Event);
                              return null;
                           case ":chooser":
                              if(_container.sessionDataManager.method_1("fuse_habbo_chooser"))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(_container.sessionDataManager.method_1("fuse_furni_chooser"))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_622:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_849 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_849);
            }
            if(var_488 == null)
            {
               var_489.x = 0;
               var_489.y = 0;
               var_489.z = 0;
               var_488 = _loc4_.getScreenPoint(var_489);
               var_849 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_489.x = 0;
            var_489.y = 0;
            var_489.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_489);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_488.x || _loc8_.y != var_488.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_488,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_308;
      }
