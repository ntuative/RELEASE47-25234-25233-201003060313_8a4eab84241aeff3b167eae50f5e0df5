package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1031:UserDataManager;
      ...
      {
         if(var_37 == RoomSessionEvent.const_292 && _connection != null)
         {
            var_37 = RoomSessionEvent.const_94;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1031 as IUserDataManager;
      }
