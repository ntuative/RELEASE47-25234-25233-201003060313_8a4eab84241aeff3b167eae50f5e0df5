package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_775:String = "selection_arrow";
      
      private static const const_777:String = "tile_cursor";
      
      private static const const_281:String = "RCL_PUBLICROOM_";
      
      private static const const_495:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_348:String = "place_holder";
      
      private static const const_1102:String = const_348;
      
      private static const const_1427:int = 0;
      
      private static const const_776:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_594:String = "RCL_LOADER_READY";
      ...
      private var var_1042:IEventDispatcher = null;
      
      private var var_1267:Map = null;
      
      private var _furniRevisions:Map = null;
      
      private var _wallItemTypes:Map = null;
      
      private var var_585:Map = null;
      ...
      private var var_171:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_496 = [];
         var_495 = [];
         var_2052 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2048 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_416 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_496.indexOf(_loc4_) == -1)
                     {
                        var_496.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_30:
                     if(var_495.indexOf(_loc4_) == -1)
                     {
                        var_495.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_287,_loc4_);
      ...
      {
         if(var_171 != null && var_171.hasWorldType(const_281 + param1))
         {
            return var_171.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_497.add(_loc10_,_loc11_);
                              if(var_496.indexOf(_loc14_) < 0)
                              {
                                 var_496.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_495.indexOf(_loc14_) < 0)
                              {
                                 var_495.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_416 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_416.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_352 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_352.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_416.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_416.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_348,const_495,ROOM_CONTENT,const_777,const_775];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2052.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      {
         if(var_496.indexOf(param1) >= 0)
         {
            return const_348;
         }
         if(var_495.indexOf(param1) >= 0)
         {
            return const_495;
         }
         if(var_171 != null && (var_171.type == param1 || var_171.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1102;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_585.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_417 != null)
         {
            _loc2_ = var_417.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1377);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2048.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1267.add(_loc5_,_loc8_);
               var_171 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_287,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_463,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_171 != null && (var_171.type == param1 || var_171.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_61;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_61;
      ...
      private function continueInitilization() : void
      {
         if(var_2051)
         {
            ...
            if(var_1042 != null)
            {
               var_1042.dispatchEvent(new Event(const_594));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_171 != null)
         {
            return var_171.getWorldHeightScale(const_281 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1042 = param1;
            var_2054 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2050 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2049 = param2.getKey("public.room.dynamic.download.url","");
            var_2053 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_37 = const_776;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_352.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_417 != null)
         {
            var_417.remove(param1);
            var_417.add(param1,param2);
         }
         if(var_415 != null)
         {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_399.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_281 + param1) == RoomObjectCategoryEnum.const_61)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1267.getValue(param1) != null)
         {
            var_171 = var_1267.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_474,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_171 != null)
         {
            return var_171.getWorldScale(const_281 + param1);
         }
         return 32;
      }
