package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1463:int = 1500;
      
      private var var_1464:int = 255;
      
      private var var_1462:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_538:
                  _loc2_.setString(RoomObjectVariableEnum.const_550,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_587:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_481:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_220)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_506:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_846,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_837,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_552,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_77.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_104,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1395,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1178,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1175,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_104,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_138 || _loc13_ == RoomPlaneData.const_266)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_835)
         {
            ...
            {
               _loc7_ = var_1230 >> 16 & 255;
               _loc8_ = var_1230 >> 8 & 255;
               _loc9_ = var_1230 & 255;
               _loc10_ = var_1008 >> 16 & 255;
               _loc11_ = var_1008 >> 8 & 255;
               _loc12_ = var_1008 & 255;
               _loc13_ = (_loc2_ - var_835) / var_1463;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1464 + (var_1462 - var_1464) * _loc13_;
               _color = _loc3_;
               var_1293 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_552,_loc3_);
         }
      }
   }
}
