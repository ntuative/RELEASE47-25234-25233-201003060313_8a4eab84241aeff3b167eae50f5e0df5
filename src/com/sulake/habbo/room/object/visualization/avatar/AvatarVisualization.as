package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1622:int = 1;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1186:Number;
      ...
      private var var_785:AvatarVisualizationData = null;
      ...
      {
         var_785 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_384.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_519);
         ...
         var _loc14_:Number = _loc8_ - var_1186;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_340);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_289 != _loc3_.getUpdateID() || var_209 != param1.scale || var_164 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_467 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_467;
            ...
            if(var_605 != _loc7_)
            {
               for each(_loc49_ in var_384.getKeys())
               {
                  var_384.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_785.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_384.remove(_loc5_);
               var_384.add(_loc5_,_loc6_);
               var_605 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_319);
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_48,_loc25_);
            _loc6_.initActionAppends();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_260);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_508);
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_426);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_53)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_437);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_333,AvatarAction.const_1337[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_979);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_972,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_839);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_891);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1022,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_549);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_717);
               _loc58_ = 100;
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_880);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1024,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_401);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_402) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_593);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_405);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_943);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_517,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_878))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_785.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_784.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_784)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_384 != null)
         {
            _loc1_ = var_384.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_384.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
