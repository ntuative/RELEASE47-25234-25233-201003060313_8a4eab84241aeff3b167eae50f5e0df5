package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_270:int = 1;
      ...
      private var var_670:IPlaneRasterizer = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_270 || _type == const_188))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_829 || false && false && !var_155 || var_613 == null)
         {
            return;
         }
         ...
         if(var_155)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_477);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_194.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_613.updateMask(var_59,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_669.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_256.length)
            {
               _loc4_ = var_256[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  ...
                  var_998.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_155 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_670 != null)
         {
            return var_670.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_270 || _type == const_188)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_194.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_669.length)
                  {
                     _loc7_ = var_669[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(var_829)
         {
            ...
            while(_loc6_ < var_256.length)
            {
               _loc5_ = var_256[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_670 != null)
            {
               _loc3_ = var_670.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1457,var_1869,var_1871,var_1870,var_1872,param2);
               if(_loc3_ != null)
               {
