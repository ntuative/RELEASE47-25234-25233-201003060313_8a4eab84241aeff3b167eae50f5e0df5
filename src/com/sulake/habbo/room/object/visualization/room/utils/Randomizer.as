package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1442:int = 16777216;
      
      public static const const_1539:int = 1;
       
      
      private var var_2341:int = 69069;
      
      private var var_1134:int = 1;
      
      private var var_2342:int = 5;
      
      private var var_1400:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1400 * param2);
      }
      ...
      {
         var _loc1_:int = var_2341 * var_1134 + var_2342;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
