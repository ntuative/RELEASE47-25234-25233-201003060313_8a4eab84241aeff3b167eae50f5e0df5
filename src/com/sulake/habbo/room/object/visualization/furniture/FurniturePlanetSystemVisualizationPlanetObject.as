package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1103:Number = 30;
      ...
      private var var_703:Vector3d;
      
      private var var_1147:Number;
      ...
      {
         var_703 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1147 = param3;
         var_2088 = param4 * 0 * 2 / 360;
         var_1520 = param5 * 0 * 2 / 360;
         _height = param6;
         var_861 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1147 * Math.cos(var_861 + var_1520);
         var _loc4_:Number = var_1147 * Math.sin(var_861 + var_1520);
         var _loc5_:Number = _height;
         var_703.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_703.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_703.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_703.add(param1);
         }
