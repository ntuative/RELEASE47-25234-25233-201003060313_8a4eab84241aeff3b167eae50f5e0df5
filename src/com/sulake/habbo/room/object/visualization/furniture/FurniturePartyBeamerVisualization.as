package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_763:int = 15;
      
      private static const const_1084:int = 2;
      
      private static const const_346:int = 2;
      
      private static const const_764:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1002[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1001[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1002 = new Array();
         var_1002.push(Math.random() * _loc2_ * 1.5);
         var_1002.push(Math.random() * _loc2_ * 1.5);
         var_1003 = new Array();
         var_1003.push(1);
         var_1003.push(-1);
         var_1000 = new Array();
         var_1000.push(const_1084);
         var_1000.push(const_1085);
         var_1001 = new Array();
         var_1001.push(getRandomAmplitudeFactor());
         var_1001.push(getRandomAmplitudeFactor());
      }
