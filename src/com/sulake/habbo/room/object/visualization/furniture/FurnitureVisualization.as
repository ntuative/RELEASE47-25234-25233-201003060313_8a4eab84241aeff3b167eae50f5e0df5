package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1406:Number = Math.sqrt(0.5);
      ...
      protected var var_1416:String = null;
      ...
      private var var_1297:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1416 != null && var_1416.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2276,param1);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_845:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_811:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_2170 != param1 || var_2167 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2168 != param1 || var_2169 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2276 = _loc3_.getNumber(RoomObjectVariableEnum.const_212);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_195));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1416 = _loc3_.getString(RoomObjectVariableEnum.const_328);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_289 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2266)
         {
