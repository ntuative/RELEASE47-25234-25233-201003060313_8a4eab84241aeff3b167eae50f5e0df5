package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1030:int = -1000000000;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_945,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_548);
         var _loc8_:int = 0;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new ObjectsMessageEvent(method_10));
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_936:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_835:
                     _loc10_ = "std";
               }
