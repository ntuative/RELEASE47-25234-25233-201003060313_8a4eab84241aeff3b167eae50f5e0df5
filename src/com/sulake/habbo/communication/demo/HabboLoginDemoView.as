package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_355:HabboCommunicationDemo;
      ...
      {
         var_355.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_355.shockwaveClientUrl = var_118.shockwaveClientUrl;
         var_355.ssoTicket = var_118.ticket;
         var_118.removeEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_118.removeEventListener(SSOTicket.const_258,onParsedTicketFailure);
         var_118 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1425,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_355 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_355.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_455,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_355.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1425,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_355.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_355.habboCommunication.habboWebLogin(name,password);
         var_118 = new SSOTicket(var_355.assets,_loc2_,_loc1_);
         var_118.addEventListener(SSOTicket.const_307,onParsedTicketSuccess);
         var_118.addEventListener(SSOTicket.const_258,onParsedTicketFailure);
      }
