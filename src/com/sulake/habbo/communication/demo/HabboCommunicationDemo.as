package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1476:ILogger;
      
      private var var_1242:String;
      
      private var var_1931:String;
      
      private const const_1425:String = "fuselogin";
      
      private var var_312:ICoreCommunicationManager;
      
      private var var_405:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1012)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_180);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_311:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1930)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_678 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_678);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_179);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_1012 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_224);
         param1.send(new VersionCheckMessageComposer(401,var_1242,var_1931));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1425,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_405.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_405.getSharedKey(16).toUpperCase();
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1425,"/");
      ...
      {
         var_678 = _habboConfiguration.getKey("sso.ticket",null);
         var_1242 = _habboConfiguration.getKey("flash.client.url","");
         var_1931 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_678 != null)
         {
            var_72.mode = HabboConnectionType.const_454;
            var_72.initConnection(HabboConnectionType.const_250);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1476 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_581);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_72.mode)
         {
            case HabboConnectionType.const_454:
               ...
               var_1013 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_1013,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1272:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1248:
               var_677 = generateRandomHexString(30);
               var_405 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_405.init(var_677);
               _loc8_ = var_405.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1013);
         ...
         var_405 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_405.init(_loc14_);
            _loc15_ = var_405.getPublicKey(10);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_218);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_102,onRoomSessionEnded);
      }
