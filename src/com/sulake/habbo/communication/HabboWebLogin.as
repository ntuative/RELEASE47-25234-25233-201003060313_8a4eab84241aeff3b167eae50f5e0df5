package com.sulake.habbo.communication
{
   ...
   public class HabboWebLogin extends EventDispatcher implements IHabboWebLogin
   {
      ...
      public function HabboWebLogin(param1:String, param2:String, param3:String, param4:IEventDispatcher = null)
      {
         ...
         _name = param1;
         _password = param2;
         var_1802 = "https://" + param3 + "/account/submit";
         var_1801 = "https://" + param3 + "/security_check";
         var_1803 = "https://" + param3 + "/account/reauthenticate";
      }
      
      private function securityCheckComplete(param1:Event = null) : void
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_18.removeEventListener(Event.COMPLETE,securityCheckComplete);
         removeListeners(var_18);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
            dispatchEvent(new Event(HabboWeb.const_205));
         }
      }
      ...
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_18.removeEventListener(Event.COMPLETE,credentialsComplete);
         removeListeners(var_18);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
      ...
      {
         var _loc1_:URLRequest = new URLRequest(var_1801);
         var_18 = new URLLoader();
         var_18.addEventListener(Event.COMPLETE,securityCheckComplete);
         configureListeners(var_18);
         var_18.load(_loc1_);
      }
      ...
      public function requestReAuthenticate() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(var_1803);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         var_18 = new URLLoader();
         var_18.addEventListener(Event.COMPLETE,reauthenticateComplete);
         configureListeners(var_18);
         var_18.load(_loc2_);
      }
      ...
      {
         var _loc2_:URLLoader = URLLoader(param1.target);
         var_18.removeEventListener(Event.COMPLETE,reauthenticateComplete);
         removeListeners(var_18);
         var _loc3_:String = _loc2_.data;
         if(_loc3_.indexOf("Redirecting") > -1)
         {
      ...
      private function requestCredentials() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(var_1802);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         var_18 = new URLLoader();
         var_18.addEventListener(Event.COMPLETE,credentialsComplete);
         configureListeners(var_18);
         var_18.load(_loc2_);
      }
