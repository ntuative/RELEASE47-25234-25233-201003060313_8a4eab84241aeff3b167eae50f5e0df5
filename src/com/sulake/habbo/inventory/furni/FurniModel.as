package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_331:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_221,onObjectPlaced);
         var_478 = new Timer(const_1088,1);
      ...
      {
         return var_12.getSubCategoryViewId() == InventorySubCategory.const_249;
      }
      ...
      {
         return var_12.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_404.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_404.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_653)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_221,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_182)
         {
         ...
         {
            var_1006 = param1.ref;
            if(!var_12.recyclerModel.running)
            {
               requestClose();
            }
            var_831 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_337)
         {
         ...
         if(var_672 == null)
         {
            var_672 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_672.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_12.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_12.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_249:
               ...
               break;
            case InventorySubCategory.const_1017:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_12.checkCategoryInitilization(InventoryCategory.const_418);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_75 && false)
         {
            ...
            {
               case const_42:
                  var_12.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_43:
                  var_12.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_331:
                  var_12.toggleInventoryPage(InventoryCategory.const_146);
            }
         }
      }
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = var_12.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc2_:TradingModel = var_12.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = var_12.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_831 && param1.type == RoomEngineObjectEvent.const_221)
         {
            var_12.showView();
            var_831 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_285 || _loc3_.category == FurniCategory.const_337 || _loc3_.category == FurniCategory.const_312)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_404.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_404 = new Map();
         var_404.add(const_42,new Array());
         var_404.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
