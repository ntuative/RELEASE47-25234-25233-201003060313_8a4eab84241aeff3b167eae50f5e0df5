package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1019:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_575 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_575.width;
         var_92 = var_575.height;
         var_1020 = param5;
         var_844 = param6;
         var_222 = Math.floor(var_1020 / _thumbWidth);
         var_19 = new BitmapData(var_1020,var_844);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_222 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_222 - param1.x - 1;
         ...
         if(param1.y < var_485 - 1)
         {
            ...
            var_19.fillRect(new Rectangle(0,0 - var_92,var_19.width,var_92),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == var_222 - 1)
            {
               _loc11_ = new BitmapData(var_19.width,0 - var_92);
               _loc2_ = new Rectangle(0,0,var_19.width,0 - var_92);
               _loc11_.copyPixels(var_19,_loc2_,new Point(0,0),null,null,true);
               var_19 = _loc11_;
               --var_485;
            }
         }
         if(var_19.height < var_844)
         {
            _loc12_ = new BitmapData(var_19.width,var_844);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_575.width,var_575.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_575.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_575,var_575.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1019 != null)
         {
            _loc1_ = var_1019.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_222 * _thumbWidth,var_1020),Math.max(var_485 * var_92,var_844),true,16777215);
            ...
            while(_loc4_ < var_222)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_19.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_92),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_222 && var_19.height < _loc3_.y * var_92)
         {
            _loc2_ = new BitmapData(var_19.width,var_19.height + var_92);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_222 - 1),var_92);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_222 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_222 - 1),0 - var_92);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,var_92),null,null,true);
         var_19 = _loc2_;
      }
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_222));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_222);
         var _loc3_:int = param1 % var_222;
         return new Point(_loc3_,_loc2_);
      }
