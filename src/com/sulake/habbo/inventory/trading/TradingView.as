package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_771:uint = 4284532064;
      
      private static const const_772:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_182)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_921)
            {
            ...
            var_350.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_372);
            var_350.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_170)
            {
               var_170.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_170.stop();
               var_170 = null;
            }
            if(var_350 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1477 == null)
         {
            var_1477 = createMinimizedWindow();
         }
         if(!var_1934)
         {
            return var_64;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_170 == null)
         {
            var_170 = new Timer(1000,3);
            var_170.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_170.reset();
         var_170.repeatCount = 3;
         var_170.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_771) : uint(const_772);
            }
