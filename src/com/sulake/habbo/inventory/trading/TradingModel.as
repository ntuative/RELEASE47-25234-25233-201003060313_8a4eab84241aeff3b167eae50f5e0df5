package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1298:uint = 9;
      ...
      private var var_1286:int = -1;
      
      private var var_229:Map;
      
      private var var_713:int = -1;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_501 = false;
         var_712 = false;
         var_49.updateItemList(var_713);
         var_49.updateItemList(var_1286);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_49.alertPopup(TradingView.const_990);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_713)
            {
               var_501 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_712 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_713)
            {
               var_49.alertPopup(TradingView.const_953);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_37 + " NEW STATE: " + param1 + " OWN: " + var_501 + " OTHER: " + var_712);
         ...
         {
            case const_173:
               if(param1 == const_167 || param1 == const_200)
               {
                  var_37 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_49.setMinimized(param1 != InventoryCategory.const_75);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_182)
            {
      ...
      public function close() : void
      {
         if(var_570)
         {
            if(var_37 != const_173 && var_37 != const_200)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_173;
            var_10.toggleInventorySubPage(InventorySubCategory.const_1017);
            var_570 = false;
         }
         var_49.setMinimized(false);
      }
