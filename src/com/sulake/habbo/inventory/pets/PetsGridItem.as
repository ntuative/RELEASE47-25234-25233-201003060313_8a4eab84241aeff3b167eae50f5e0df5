package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:IAvatarImage = param5.createPetImage(param2.figure,AvatarScaleType.const_53);
         if(_loc7_ == null)
         {
            return;
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_51:
               var_1043.setSelectedGridItem(this);
               var_855 = true;
               break;
            ...
            case WindowMouseEvent.const_29:
               ...
               {
                  var_855 = false;
                  var_1043.placePetToRoom(var_1195.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1619) : uint(const_1618);
      }
