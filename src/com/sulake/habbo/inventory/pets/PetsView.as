package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_460 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_603.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_603.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_460.removeGridItem(_loc2_.window);
         if(var_316 == _loc2_)
         {
            var_316 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_603.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_460.addGridItem(_loc2_.window);
            var_603.add(param1.id,_loc2_);
            if(var_316 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImage(_loc12_.figure,AvatarScaleType.const_53);
            if(_loc13_ == null)
            {
               return;
            }
