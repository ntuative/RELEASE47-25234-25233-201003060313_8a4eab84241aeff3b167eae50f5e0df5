package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1618:int = 13421772;
      ...
      protected var var_2280:BitmapData;
      
      protected var var_939:Boolean;
      
      protected var var_2265:Boolean;
      
      protected var var_1866:int;
      
      protected var _mainCategory:String;
      
      protected var var_445:int = 0;
      
      protected var var_1370:String;
      
      private const const_1619:int = 8947848;
      ...
      private const const_1435:Number = 0.2;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_653)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1424));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1435;
               _loc1_.blend = const_1435;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1383 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2280;
               _loc5_.visible = true;
            }
            else
            {
