package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsModel implements IInventoryModel
   {
      ...
      public function addAchievement(param1:Achievement, param2:Boolean = true) : void
      {
         ...
         while(_loc4_ < var_356.length)
         {
            ...
            if(_loc5_.type == param1.type && _loc5_.level < param1.level)
            {
               ...
               _loc5_.image = var_346.getBadgeImage(param1.badgeId);
               _loc3_ = true;
            }
            _loc4_++;
         }
         if(!_loc3_)
         {
            param1.image = var_346.getBadgeImage(param1.badgeId);
            var_356.push(param1);
         }
         if(param2)
         {
      ...
      {
         if(param1 == InventoryCategory.const_304 && false)
         {
            var_12.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_ACHIEVEMENTS));
         }
      }
