package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1523,var_1522);
         }
      }
      ...
      {
         if(param1 != var_1659 || param2 != var_1660)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1663);
      }
      ...
      {
         if(var_12 != null && false && var_228 != null)
         {
            var_12.furniModel.removeLockFrom(var_228.id);
            var_228 = null;
         }
      }
