package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1648:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_346 = param6;
         var_346.events.addEventListener(BadgeImageReadyEvent.const_119,onBadgeImageReady);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_279.length)
         {
            _loc2_ = var_279[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_279.length)
               {
                  if((var_279[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_279[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_12.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_346.getBadgeImage(param1);
            var_279.push(_loc8_);
            if(param2)
            {
