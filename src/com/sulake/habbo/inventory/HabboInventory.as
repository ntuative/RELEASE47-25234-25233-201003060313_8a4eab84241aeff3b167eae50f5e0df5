package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_804:IRoomSession;
      ...
      private const const_1627:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_20 != null)
         {
            var_20.events.removeEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_362,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_102:
               var_804 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_362:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_728));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_48.getValue(InventoryCategory.const_75));
      }
      ...
      {
         return PetsModel(var_48.getValue(InventoryCategory.const_146));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_969));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1627);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_304));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_249:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_803.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_803.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_249));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_346 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_803.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_48.getValue(InventoryCategory.const_418) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_978 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_274));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_362,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_418,_loc3_);
         ...
         var_48.add(InventoryCategory.const_75,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_346);
         var_48.add(InventoryCategory.const_274,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_728,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_346);
         var_48.add(InventoryCategory.const_304,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_249,_loc8_);
         ...
         var_48.add(InventoryCategory.const_146,_loc10_);
