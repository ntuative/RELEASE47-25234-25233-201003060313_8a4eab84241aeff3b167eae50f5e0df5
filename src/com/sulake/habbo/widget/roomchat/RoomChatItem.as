package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1411:Number = 8;
       
      
      private var var_1124:Number;
      ...
      {
         _widget.onItemMouseOut(var_946,var_947,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_946,var_630,var_947,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1125 = param1.chatType;
         var_946 = param1.userId;
         var_630 = param1.userName;
         var_947 = param1.userCategory;
         _message = param1.text;
         var_1124 = param1.userX;
         var_183 = param1.userImage;
         var_945 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_183 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_376 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_945 != 0)
            {
               _loc30_ = uint(var_945 >> 16 & 255);
               _loc31_ = uint(var_945 >> 8 & 255);
               _loc32_ = uint(var_945 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1125 == RoomWidgetChatUpdateEvent.const_235)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_630);
            }
            else if(var_1125 == RoomWidgetChatUpdateEvent.const_253)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_630);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_342 + _loc20_.textWidth + const_487;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_946,var_947,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_946,var_947,_roomId,_roomCategory,param1);
      }
