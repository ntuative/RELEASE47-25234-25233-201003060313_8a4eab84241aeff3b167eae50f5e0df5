package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1409:int = 5;
      
      private static const const_487:int = 16;
      
      private static const const_1037:int = 20;
      
      private static const const_342:int = 10;
      
      private static const const_1038:int = 40;
      ...
      private var var_424:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_944 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1629 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1628 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_629 = new Timer(1000,1);
         var_629.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_763 = new Timer(5000,1);
         var_763.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_57,HabboWindowStyle.const_41,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _window.addEventListener(WindowEvent.const_369,onWindowMoved);
         var_1122 = true;
         var_121 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1630 = _loc2_.width + const_487 + _loc6_.width + const_1037;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1038,_loc8_.width) + const_487);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_944 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_121 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_424);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_424);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_448);
