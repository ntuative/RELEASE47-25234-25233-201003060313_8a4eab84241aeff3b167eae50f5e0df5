package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_378:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_378 = new Sprite();
            var_378.addChild(new Bitmap(_image));
            var_378.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_378.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_378);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1416 != "")
         {
            HabboWebTools.openWebPage(var_1416);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_378 != null)
         {
            var_378.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_378 = null;
         }
         if(_image != null)
         {
