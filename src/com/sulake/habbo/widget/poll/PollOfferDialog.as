package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_248:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_656:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1192:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_37 = const_1192;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_527,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_37 = const_656;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_367,_id));
