package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_238:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_79,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_431,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_436,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_417,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_368,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_79,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_431,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_436,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_417,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_368,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_64:
               hideInterface();
               var_238 = false;
               var_159 = param1.objectId;
               var_198 = param1.text;
               var_12 = param1.controller;
               showInterface();
               break;
            ...
            case RoomWidgetPresentDataUpdateEvent.const_417:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_368:
               if(!var_238)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_431:
               if(!var_238)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_79:
               if(!var_238)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_601,var_159);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_57,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1043,const_1044,2,2),null,0) as IWindowContainer;
