package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_79,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_64:
               ...
               showInterface();
               break;
            case RoomWidgetEcotronBoxDataUpdateEvent.const_79:
               if(!var_238)
               {
                  return;
               }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_79,onObjectUpdate);
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_716,var_159);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_57,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1043,const_1044,2,2),null,0) as IWindowContainer;
