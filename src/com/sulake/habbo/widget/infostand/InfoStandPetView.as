package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1640:String = "level";
      
      private var var_102:IItemListWindow;
      
      private const const_1636:String = "energy";
      
      private var var_1195:Map;
      
      private const const_1634:String = "nutrition";
      
      private var var_61:IItemListWindow;
      
      private const const_1635:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1633:int = 158;
      
      private const const_1639:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_262:PetCommandTool;
      
      private const const_1637:uint = 11184810;
      
      private const const_1632:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_212 != null)
         {
            var_102 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_102 == null || var_212 == null || var_61 == null)
         {
            return;
         }
         ...
         var_212.height = NaN;
         _window.width = Math.max(var_212.width,var_61.width);
      ...
      private function openTrainView() : void
      {
         if(var_262 == null)
         {
            var_262 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1195.getValue(var_710) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_262.showWindow(true);
            var_262.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1640,param1.level,param1.levelMax);
         updateStateElement(const_1632,param1.experience,param1.experienceMax);
         updateStateElement(const_1636,param1.energy,param1.energyMax);
         updateStateElement(const_1634,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_710 = param1.id;
         var_1195.remove(param1.id);
         var_1195.add(param1.id,param1);
         if(var_262 && var_262.isVisible() && param1.isOwnPet)
         {
            var_262.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_262.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_374,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1633,const_1639,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1637);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1635);
