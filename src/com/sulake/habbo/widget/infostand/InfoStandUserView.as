package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_911:TagListRenderer;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_911 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc4_:* = [];
         var_61.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_61.numListItems)
            {
               _loc13_ = var_61.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_911.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_61.getListItemByName(param1) as IRegionWindow;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_61.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_841:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_848:
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_209:
