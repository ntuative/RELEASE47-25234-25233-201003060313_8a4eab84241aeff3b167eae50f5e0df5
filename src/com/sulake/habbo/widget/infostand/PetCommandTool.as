package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_357:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_1053:Map;
      
      private const const_1643:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_1053 = new Map();
         var_358 = new Timer(const_1643);
         var_358.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_509,param1);
      ...
      {
         var_1053.remove(param1);
         var_1053.add(param1,param2);
         if(param1 != var_710)
         {
            return;
         }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_357 == null)
         {
            ...
            var_357 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_357 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_357.x = 200;
            var_357.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      {
         var _loc2_:Array = var_1053.getValue(var_710) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_439,var_710));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_729,var_710,var_2125 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1053.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_710);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_43.setParamFlag(WindowParam.const_85,true);
         var_43.context.getDesktopWindow().addEventListener(WindowEvent.const_45,onWindowDesktopResized);
