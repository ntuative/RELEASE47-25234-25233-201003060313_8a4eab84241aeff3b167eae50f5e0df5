package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_638,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_114,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_55,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_638,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_114,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_55,onDoorbellHandled);
      }
