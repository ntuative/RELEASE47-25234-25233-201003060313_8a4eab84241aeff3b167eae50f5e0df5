package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_813:MeMenuSettingsView;
      
      private var var_2362:int;
      
      private var var_553:BitmapData;
      
      private var var_987:Number = 1;
      ...
      {
         if(param1.type != WindowEvent.const_369)
         {
            return;
         }
         var_813.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return param1 / var_1441 * (var_987 - var_656) + var_656;
      }
   }
}
