      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_847);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_938));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_873));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_246);
               break;
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_617);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","HabboNavigatorCom_hh_room_erics_png") == "true";
               if(false && _loc4_)
               {
