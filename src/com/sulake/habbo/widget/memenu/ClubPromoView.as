package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_482:String = "CPV_MODE_TRIAL";
      
      public static const const_1149:String = "CPV_MODE_FULL";
      ...
      private const const_1131:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1131,_loc7_,"image/png");
      ...
      {
         _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_520));
      }
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1131))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1131) as BitmapDataAsset;
            if(!_loc2_)
            {
               return false;
            }
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_583,_loc2_.text,var_698 == const_482);
