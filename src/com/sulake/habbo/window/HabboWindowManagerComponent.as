package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_352:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1121:uint = 1;
      ...
      private var var_1333:IEventDispatcher;
      
      private var var_2379:uint = 0;
      
      private var var_1335:ProfilerAgentTask;
      
      private var var_1332:ProfilerOutput;
      
      private var var_736:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1333 = Component(param1).events;
         var_431 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_736 = new WindowRenderer(_loc4_);
         var_239 = new Array(const_352);
         var _loc6_:int = 0;
         while(_loc6_ < const_352)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_736,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_239[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_221 = var_239[const_1121];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_221.getMouseCursor().defineCustomCursorType(MouseCursorType.const_294,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_221.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1216,_loc7_);
      }
      ...
      {
         return var_239[param1].getDesktopWindow().getChildAt(var_221.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1332 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1332 = new ProfilerOutput(_loc3_,this,var_736);
               var_1334 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1334);
               var_1335 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1335);
               var_1085 = true;
            }
         }
      }
      ...
      {
         return var_221.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1333.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_352 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1333.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_352)
         {
         ...
         if(WindowContext.var_1366.length > 0)
         {
            WindowContext.var_1366.flush();
         }
         var_1333.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_221.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1371,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1292,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1193,param2.name + ": " + param2.toString());
            }
         }
      }
   }
