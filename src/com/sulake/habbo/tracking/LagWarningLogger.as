package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1112 || var_1388 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1389 == 0 || _loc1_ - var_1389 > var_1388)
         {
            if(_connection != null)
            {
      ...
      {
         var_1112 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1388 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
