package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_761:BitmapData = null;
      ...
      private var var_762:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_432,0,0,_loc4_,var_1387,var_762,var_761));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1624 = int(_config.getKey("interstitial.interval","30000"));
         var_1625 = int(_config.getKey("interstitial.show.time","5000"));
         var_1385 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1119 = _loc2_.imageUrl;
         var_1387 = _loc2_.clickUrl;
         if(var_1119 != "" && var_1387 != "")
         {
            _loc3_ = var_1119;
            ...
            _loc4_ = new URLRequest(var_1119);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1120 = _loc2_.imageUrl;
         var_1626 = _loc2_.clickUrl;
         var_628 = getTimer();
         if(var_1120 != "")
         {
            _loc3_ = var_1120;
            ...
            if(var_211 == null)
            {
               var_211 = new Timer(var_1625,1);
               var_211.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_211.reset();
            ...
            var_211.start();
            _loc4_ = new URLRequest(var_1120);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_365,0,0,param1.bitmapData,var_1626));
            var_628 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_761 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1385 > 0 && var_1386 >= var_1385)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_628;
         if(_loc1_ > var_1624)
         {
            ++var_1386;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_416));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_762 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
