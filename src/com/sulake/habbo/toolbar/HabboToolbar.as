package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_128,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_920,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_398,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_723,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_996,onHideWindowEvent);
         var_37 = true;
