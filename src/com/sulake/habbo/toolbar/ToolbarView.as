package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_995:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_192 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_928,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_995 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_995)
         {
            _window.addEventListener(WindowMouseEvent.const_51,onToolbarMouseDown);
         ...
         var_1211 = _loc7_.toolbar.@margin_bottom;
         var_1450 = _loc7_.toolbar.@min_group_margin;
         var_1449 = _loc7_.toolbar.@margin_to_extrabar;
         var_270 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_255,param1,param2,_window,var_270);
         createGroupsFromXmlList(_loc9_,var_558,param1,param2,var_192,var_270);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_130,var_472,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1450,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1211) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1450,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1211) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_130,var_472);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_558.length)
         {
            _loc2_ = var_558[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_472);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_130,var_472);
         }
      }
