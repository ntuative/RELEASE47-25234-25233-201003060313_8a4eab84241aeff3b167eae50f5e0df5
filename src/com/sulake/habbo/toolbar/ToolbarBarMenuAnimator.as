package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1104:Number = 90;
      
      private static const const_770:int = 50;
      
      private static const const_1092:Number = 25;
      
      private static const const_1091:int = 50;
      ...
      private var var_1009:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1009 = param2;
         var_566 = new Timer(const_1092);
         var_566.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_479.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_479.splice(_loc3_,1);
            var_480.splice(_loc3_,1);
         }
         var_480.push(param1.name);
         var_479.push(param2);
         param1.addEventListener(WindowEvent.const_369,windowEventListener);
         param1.addEventListener(WindowEvent.const_228,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_479[var_480.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1009.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_305.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_305.splice(var_305.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1009.getIconLoc(param1.iconId);
      ...
      {
         return var_480[var_479.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_305[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_565[_loc3_] = new Array();
            }
            if(var_565[_loc3_].indexOf(param1) < 0)
            {
               var_565[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_770 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_770 || param1.desktop.height - param1.y < const_1091;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_480[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_565[_loc3_].length)
                  {
                     repositionWindow(var_565[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
