package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_517:ToolbarIconGroup;
      ...
      private var var_1066:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_886 = new Array();
         var_2321 = new Array();
         var_1066 = new ToolbarIconBouncer(0.8,1);
         super();
         var_517 = param1;
         ...
         _events = param5;
         var_270 = param6;
         var_1298 = new Timer(40,40);
         var_1298.addEventListener(TimerEvent.TIMER,updateBouncer);
         var_98 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_448,HabboWindowStyle.const_41,HabboWindowParam.const_40,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1543[var_1064.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_270)
               {
                  var_270.repositionWindow(var_723,true);
               }
               if(_events != null)
               {
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_886[var_596.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_98.toolTipCaption = "${toolbar.icon.tooltip." + var_2180.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_270 != null)
         {
            var_270.animateWindowIn(this,param1,param2,var_723,param3,param4,getMenuYieldList(param1));
         }
      }
      
      private function updateAnimator(param1:Event) : void
      {
         if(var_428 != null && _window != null)
         {
            var_428.update(_window);
            if(var_428.hasNextState())
            {
               state = var_428.nextState;
            }
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1064 = new Array();
         var_2180 = param1.@id;
         var_2179 = int(param1.@window_offset_from_icon);
         var_2178 = int(param1.@window_margin);
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               var_1064.push(_loc5_.id);
               var_1543.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(var_1063 == "-1")
                  {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_270 != null)
         {
            var_270.hideWindow(param1,param2,var_723,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_270 != null)
         {
            var_270.positionWindow(this,param1,param2,var_723,param3,getMenuYieldList(param1));
         }
      }
      ...
      {
         if(var_1066 != null && _window != null)
         {
            var_1066.update();
            _window.y = var_1066.location;
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1065)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_428 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_87,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_2178 + var_517.windowMargin;
      }
