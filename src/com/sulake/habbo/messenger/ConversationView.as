package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1123:int = 20;
      
      private static const const_790:int = 100;
      ...
      private var var_1572:IContainerButtonWindow;
      
      private var var_520:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_144 = param1;
         var_1572 = initButton("follow_friend",onFollowButtonClick,param2);
         var_51 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2216 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_649 || param3.type == Message.const_636 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_520.messages.length - const_790);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_520.messages.length)
         {
            refreshEntry(true,_loc1_,var_520.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_520 == null || _loc1_.id != var_520.id)
         {
            var_520 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_790 + const_1123)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_144.send(new FollowFriendMessageComposer(var_520.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1122;
         param1.invalidate();
      }
   }
}
