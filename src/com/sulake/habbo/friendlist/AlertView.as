package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1577:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1343));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1577[var_1343]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_278.width,var_278.height);
         var_278.x = _loc2_.x;
         var_278.y = _loc2_.y;
         var_1577[var_1343] = var_278;
      }
   }
}
