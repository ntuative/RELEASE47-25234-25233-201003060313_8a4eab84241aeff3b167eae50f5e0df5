package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_691:ITextFieldWindow;
      ...
      {
         var_691 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_691.procedure = onSearchInput;
         var_691.addEventListener(WindowKeyboardEvent.const_156,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_51.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_289,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_691.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
