package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1426:String = "no_reqs_info";
       
      
      private var var_1491:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_317 && _loc4_.state != FriendRequest.const_334)
            {
               ...
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_55,_loc4_.requestId));
               }
            }
         }
      ...
      {
         var_1491 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1492 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1492.procedure = onDismissAllButtonClick;
         var_1491.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_317 && _loc4_.state != FriendRequest.const_334)
            {
               _loc4_.state = FriendRequest.const_334;
               refreshRequestEntry(_loc4_);
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_259,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         method_3(param1.view,"reject");
         method_3(param1.view,"accept");
      }
      
      private function method_3(param1:IWindowContainer, param2:String) : void
      {
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_155)
         {
         ...
         else if(param1.state == FriendRequest.const_334)
         {
            _friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_922)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1491,_loc1_);
         setEnabled(var_1492,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_55,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_334;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_259,param1));
         }
      }
   }
}
