package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_164:String = "face";
      ...
      private var var_1527:OpenedToWebPopup;
      
      private var var_843:IAvatarRenderManager;
      
      private var var_200:IHabboToolbar;
      
      private var var_396:FriendListTabs;
      ...
      private var var_1528:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_868:FriendRequests;
      
      private var var_1689:int;
      
      var var_15:FriendCategories;
      
      private var var_2104:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_869:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2104 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_15 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1528 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_868.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_868.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_396.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_868 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_15.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_15.addCategory(new FriendCategory(FriendCategory.const_836,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_469,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_15.addFriend(new Friend(_loc4_));
         }
         var_396 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_499)
         {
            var_499 = new Timer(120000);
            var_499.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_499.start();
         }
         getBuddyRequests();
         registerListeners();
         var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_499.stop();
            var_499.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_499 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_144)
         {
            var_144.release(new IIDHabboMessenger());
            var_144 = null;
         }
         if(var_153)
         {
         ...
         if(var_843)
         {
            var_843.release(new IIDAvatarRenderManager());
            var_843 = null;
         }
         if(var_869)
         {
            var_869.release(new IIDHabboNotifications());
            var_869 = null;
         }
         if(var_200)
         {
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_89);
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_396.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_284));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_200 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1528.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_868.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_200.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_396.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_843.createAvatarImage(param1,AvatarScaleType.const_100);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_868.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_396.findTab(FriendListTab.const_88);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_843 = param2 as IAvatarRenderManager;
      ...
      {
         var_869 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1527 == null)
         {
            var_1527 = new OpenedToWebPopup(this);
         }
         var_1527.show(x,y);
      }
