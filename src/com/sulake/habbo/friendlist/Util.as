package com.sulake.habbo.friendlist
{
   ...
   public class Util
   {
      ...
      public static function method_13(param1:IWindowContainer) : int
      {
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc3_:int = 0;
      ...
      {
         var _loc4_:int = 0;
         Logger.log(param1 + param2 + " (" + param2.width + ", " + param2.height + "), " + param2.getParamFlag(HabboWindowParam.const_67));
