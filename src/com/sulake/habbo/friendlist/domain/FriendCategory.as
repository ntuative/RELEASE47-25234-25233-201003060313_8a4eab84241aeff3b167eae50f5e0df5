package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_286:int = 100;
      ...
      {
         return Math.ceil(this.var_210.length / const_286);
      }
      ...
      {
         if(this.var_758 >= this.getPageCount())
         {
            this.var_758 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_210[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_210.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_758 + 1) * const_286,this.var_210.length);
      }
