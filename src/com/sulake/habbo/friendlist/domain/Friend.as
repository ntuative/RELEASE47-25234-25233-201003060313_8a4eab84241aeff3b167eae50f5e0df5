package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1502:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_1015 = param1.gender;
         var_694 = param1.online;
         var_1228 = param1.followingAllowed && param1.online;
         var_605 = param1.figure;
         var_1295 = param1.motto;
         var_1294 = param1.lastAccess;
         var_1208 = param1.categoryId;
         var_1296 = param1.realName;
