package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1413:String = "noconvinfo";
      ...
      private var var_1141:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1141 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_897 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_253 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1141.prepare(var_897);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_956,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1256,true);
         var_14.header.setParamFlag(HabboWindowParam.const_651,false);
         var_14.header.setParamFlag(HabboWindowParam.const_1011,true);
         var_14.content.setParamFlag(HabboWindowParam.const_651,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1011,true);
         var_14.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1142 = ITextWindow(var_14.findChildByName("info_text"));
         var_1142.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_253.y = Util.getLowestPoint(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_1006,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_651,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_956,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1419 = var_14.height;
         var_1418 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1419 == -1 ? 0 : int(0 - var_1419);
         var _loc4_:int = var_1418 == -1 ? 0 : int(0 - var_1418);
