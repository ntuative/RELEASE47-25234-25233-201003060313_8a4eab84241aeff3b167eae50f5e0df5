package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2374:Dictionary;
      ...
      private var var_878:ISessionDataManager;
      
      private var var_877:RoomCreateViewCtrl;
      
      private var var_2090:RoomThumbnailRenderer;
      
      private var var_200:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_592:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_396:Tabs;
      
      private var var_268:MainViewCtrl;
      
      private var var_2140:Array;
      
      private var var_973:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_268 = new MainViewCtrl(this);
         var_592 = new RoomInfoViewCtrl(this);
         var_877 = new RoomCreateViewCtrl(this);
         var_2090 = new RoomThumbnailRenderer(this);
         var_973 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_268.startSearch(Tabs.const_223,Tabs.const_303,param1);
         var_268.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_200 != null)
         {
            var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_878)
         {
            var_878.release(new IIDSessionDataManager());
            var_878 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_200 != null)
         {
            var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_878 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_268.startSearch(Tabs.const_256,Tabs.const_196);
         var_396.getTab(Tabs.const_256).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_268.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
