package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1942:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1481,this._model.mode != ThumbnailEditorModel.const_54);
         setEnabled(var_1482,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._model.mode = ThumbnailEditorModel.const_54;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1481 = IButtonWindow(find("top_tab"));
         var_1482 = IButtonWindow(find("obj_tab"));
         var_1942 = IWindowContainer(find("tile_grid"));
         var_1943 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1481,onTopTabButton);
         Util.setProcDirectly(var_1482,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1942;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_399)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1943;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_38,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
      ...
      private function refreshImgSelectors() : void
      {
         ...
         refreshImgSelector(ThumbnailEditorModel.const_54);
