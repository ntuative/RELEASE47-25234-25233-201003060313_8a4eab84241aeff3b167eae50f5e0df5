package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1148:Boolean = true;
      
      private var var_781:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_454 = new Timer(100);
         var_454.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_44 = new Array();
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,104,"a"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,94,"b"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,36,"c"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,84,"d"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,80,"e"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,80,"f"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,80,"g"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,74,"h"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,416,"i"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,320,"j"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,448,"k"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,352,"l"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,384,"m"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_73,372,"n"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,416,"o"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,352,"p"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,304,"q"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_140,336,"r"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"s"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"t"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"u"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"v"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"w"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_159,0,"x"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_965 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_140)
         {
            _loc8_ = "hc_only";
         }
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_159)
         {
            _loc8_ = "vip_icon";
         }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_965.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc5_ = var_51.removeListItemAt(0);
            _loc5_.destroy();
         }
         ...
         if(!_navigator.data.hcMember)
         {
            ...
            var_51.addListItem(_loc7_);
         }
         var_1687 = _navigator.data.hcMember;
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         ...
         {
            case HabboClubLevelEnum.const_73:
               return true;
            case HabboClubLevelEnum.const_140:
               return _navigator.sessionData.method_1("fuse_use_special_room_layouts");
            case HabboClubLevelEnum.const_159:
               return _navigator.sessionData.method_1("fuse_use_vip_room_layouts");
            default:
               return false;
         }
      }
      ...
      public function dispose() : void
      {
         if(var_454)
         {
            var_454.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_454.reset();
            var_454 = null;
         }
      }
      ...
      {
         var_965.goBackToInitialState();
         var_965.input.textBackgroundColor = 4294967295;
         var_781 = var_44[0];
         if(var_1687 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_38,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_965.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_781.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1148 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1148 = true;
            _loc3_.y = 1;
