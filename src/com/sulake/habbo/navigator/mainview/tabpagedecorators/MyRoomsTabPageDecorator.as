package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_500:IDropMenuWindow;
      
      private var var_2373:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 4)
         {
            return Tabs.const_578;
         }
         return Tabs.const_196;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_500 == null ? 0 : int(var_500.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_256,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_500 == null)
         {
            var_500 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_500.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
