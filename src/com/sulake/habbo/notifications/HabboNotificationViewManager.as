package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_499:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_499;
         var _loc2_:int = 0;
         while(_loc2_ < var_230.length)
         {
            _loc3_ = var_230[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_731 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_731 + const_499;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2141,var_389,var_200);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_731 < 540;
      }
   }
}
