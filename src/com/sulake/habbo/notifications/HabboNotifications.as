package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1068:String = "badges";
      
      private static const const_1069:String = "pet_inventory";
      
      private static const const_1073:String = "pixelbalance";
      
      private static const const_1066:String = "credits";
      
      private static const const_1067:String = "inventory";
      
      private static const const_1071:String = "friendlist";
      
      private static const const_1070:String = "selectfurni";
      
      private static const const_1072:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_552:ParkBusDialogManager;
      
      private var var_550:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_394:HabboNotificationViewManager;
      ...
      private var var_655:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_809);
         }
         var _loc6_:Map = var_809["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1339);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_655 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1300);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_77:
               ...
               break;
            case CatalogPageMessageProductData.const_232:
      ...
      override public function dispose() : void
      {
         ...
         if(var_550)
         {
            var_550.release(new IIDHabboToolbar());
            var_550 = null;
         }
         if(_windowManager)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1069:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_146);
               }
               break;
            case const_1070:
               break;
      ...
      {
         if(param1 != null && this.var_394 != null)
         {
            var_394.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_927,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_551.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_912,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_178 || param2.type == WindowEvent.const_714)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_394.isSpaceAvailable() && false)
         {
            var_394.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_552 == null)
         {
            var_552 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_552 != null)
         {
            var_552.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_984.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_551.createPetImage(_loc2_.figure,AvatarScaleType.const_53);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_346);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc14_.productType == CatalogPageMessageProductData.const_83)
               {
                  _loc15_ = var_346.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc15_ = var_346.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_346.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1388,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_551.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_231);
         }
      }
      ...
      {
         var_550 = IHabboToolbar(param2);
         var_550.events.addEventListener(HabboToolbarEvent.const_87,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_346.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_809);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_809);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_337;
            }
            if(param2 == 3002)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_87)
         {
            ...
            var_394 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_809["styles"],var_809["view"],var_550);
            ...
            registerUpdateReceiver(var_394,1);
            registerUpdateReceiver(this,2);
            var_346.events.addEventListener(BadgeImageReadyEvent.const_119,onBadgeImage);
            var_550.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
