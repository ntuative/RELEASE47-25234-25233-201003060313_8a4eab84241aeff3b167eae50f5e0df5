package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1648:uint = 11129827;
      ...
      private var var_766:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_377);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_377);
         }
         if(var_244 == null)
         {
            var_244 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_244 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_766 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_766.render(param3,_loc5_);
         var _loc7_:int = 0;
