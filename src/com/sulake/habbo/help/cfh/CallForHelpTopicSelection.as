package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1050:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_639 == null || _loc3_ < 0 || _loc3_ >= var_639.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_639[_loc3_];
            main.showUI(HabboHelpViewEnum.const_682);
            main.tellUI(HabboHelpViewEnum.const_682,null);
         }
      }
   }
}
