package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_24.tellUI(HabboHelpViewEnum.const_222,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_264,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_148);
      }
      ...
      {
         var_24.showUI(HabboHelpViewEnum.const_299);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_422);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_24.showUI(HabboHelpViewEnum.const_667);
         var_24.tellUI(HabboHelpViewEnum.const_667,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_381)
            {
         ...
         var_24.tellUI(HabboHelpViewEnum.const_711);
      }
