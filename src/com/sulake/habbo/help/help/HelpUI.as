package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1697:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25234-25233-201003060242");
         var_200 = param5;
         var_99 = new Map();
         var_99.add(HabboHelpViewEnum.const_1264,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_148,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_422,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_264,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_222,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_667,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_299,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_682,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_233,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_99.add(HabboHelpViewEnum.const_1014,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_711,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_245 == HabboHelpViewEnum.const_148 || false)
         {
            return;
         }
         if(var_380 == null)
         {
            ...
            var_380 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_380 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_380 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_380 as IWindow);
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_825:
               showUI(HabboHelpViewEnum.const_1014);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_245 == HabboHelpViewEnum.const_148)
         {
            return;
         }
         if(true)
         {
            ...
            var_541.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_541.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_380.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_541[1],var_541[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_541[0],var_541[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1422;
         _window.width = _loc1_.width + var_1421;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_200 != null)
            {
               var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_24.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_568));
      }
