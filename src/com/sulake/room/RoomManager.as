package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1385:int = 0;
      
      public static const const_1357:int = 1;
      ...
      private var var_2364:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_474 = [];
         var_475 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_287,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_463,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_739,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_37 == const_1385)
         {
            if(var_822 != null)
            {
               return false;
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_46.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_474.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_474.splice(_loc2_,1);
            }
            if(false)
            {
