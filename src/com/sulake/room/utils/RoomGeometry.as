package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_521:Number = 64;
      
      public static const const_908:Number = 32;
      ...
      private var var_1494:Number = 1;
      
      private var var_79:int = 0;
      
      private var var_409:Map = null;
      
      private var var_1028:Vector3d;
      ...
      private var var_1493:Number = 1;
      
      private var var_2344:Number = 500;
      
      private var var_1495:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_86 = new Vector3d();
         var_1028 = new Vector3d();
         var_1494 = 1;
         var_1495 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1493 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_411 != param1 * var_1493)
         {
            var_411 = param1 * var_1493;
            ++var_79;
         }
      }
      ...
      {
         if(var_408 != param1 * var_1494)
         {
            var_408 = param1 * var_1494;
            ++var_79;
         }
      }
      ...
      {
         if(var_410 != param1 * var_1495)
         {
            var_410 = param1 * var_1495;
            ++var_79;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_409 != null)
         {
            ...
            var_409.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_409.add(_loc3_,_loc4_);
            ++var_79;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1028.assign(_loc22_);
         }
         else
         {
            var_1028.assign(_loc17_);
         }
         ++var_79;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_410;
         _loc2_.z *= var_411;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1028);
         if(_loc3_ < var_2345 || _loc3_ > var_2344)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_410;
            _loc2_.z *= var_411;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1028);
         }
      ...
      {
         return new Vector3d(0 * var_408,0 * var_410,0 * var_411);
      }
      ...
      {
         return scale == const_521;
      }
      
      public function get scale() : Number
      {
         return var_203 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_409 != null)
         {
            ...
            return var_409.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_203;
         var _loc6_:Number = -param1.y / var_203;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_87,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_408,0 * var_410,0 * var_411);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_408,param2.y * var_410,param2.z * var_411);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_408,param3.y * var_410,param3.z * var_411);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_408,param4.y * var_410,param4.z * var_411);
