package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2016:Number = -10000000;
      
      private var var_2019:Number = -10000000;
      
      private var var_2346:int = 0;
      
      private var var_491:RoomObjectCache;
      
      private var var_701:int;
      
      private var var_260:Sprite;
      
      private var var_1038:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1039 == 0)
         {
            checkMouseHits(var_1037.x,var_1037.y,MouseEvent.MOUSE_MOVE);
         }
         var_1039 = 0;
         ++var_1511;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_54.graphics.beginFill(var_2346);
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_701 != var_2018 || var_700 != var_2017)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_414.sortOn("z",0 | 0);
         if(_loc6_ < var_414.length)
         {
            var_414.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_414[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_702.push(_loc12_ - _loc2_);
         if(var_702.length == const_774)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_774)
            {
               _loc13_ += var_702[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_492.length)
            {
               cleanSprite(var_492[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_492 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_311 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_311.length)
         {
            _loc2_ = var_311.getKey(_loc1_);
            _loc3_ = var_311.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1038 != null)
                  {
                     var_1038.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1511,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_414.length)
         {
            return null;
         }
         return var_414[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_311 != null && param1 != null)
         {
            var_311.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_493.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_493.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2016 || param2 != var_2019)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_493.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_493.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_492.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_491.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_491.getObjectCache(param2);
