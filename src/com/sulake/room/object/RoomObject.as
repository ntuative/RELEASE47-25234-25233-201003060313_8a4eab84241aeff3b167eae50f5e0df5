package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      {
         var_1541.assign(var_223);
         return var_1541;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_508.length)
         {
            if(var_508[param2] != param1)
            {
               var_508[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_508.length)
         {
