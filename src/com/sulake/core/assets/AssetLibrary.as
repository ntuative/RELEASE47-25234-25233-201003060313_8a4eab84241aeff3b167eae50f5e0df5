package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_963:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_542:uint = 0;
      
      public static const const_963:String = "AssetLibraryReady";
      
      public static const const_1319:String = "AssetLibraryUnloaded";
      
      public static const const_474:String = "AssetLibraryLoaded";
      
      public static const const_1398:String = "AssetLibraryLoadError";
       
      
      private var var_453:XML;
      ...
      private var var_18:LibraryLoader;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_542;
         var_383 = new Dictionary(false);
         var_382 = new Dictionary(false);
         var_642 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_383)
         {
            _loc4_ = AssetTypeDeclaration(var_383[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_382)
         {
            _loc2_ = var_382[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_382[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_642)
         {
            delete var_642[_loc1_];
         }
         if(var_18 != null)
         {
            var_18.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_453 = _loc2_.manifest.copy();
         var_341 = _loc2_.resource;
         if(var_452)
         {
            AssetLibrary.fetchLibraryContents(this,var_453,var_341);
         }
         var_296 = true;
         dispatchEvent(new Event(AssetLibrary.const_474));
         dispatchEvent(new Event(AssetLibrary.const_963));
         if(var_452)
         {
            var_18.dispose();
            var_18 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_382[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1028,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1020,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_831,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_976,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_382[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_383.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_383[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_963.splice(var_963.indexOf(this),1);
            --var_542;
            var_382 = null;
            var_642 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_340.length ? getAssetByName(var_340[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1398));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_383)
         {
            _loc3_ = AssetTypeDeclaration(var_383[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_642[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(var_18 != null)
         {
            if(var_18.hasDefinition(param1))
            {
               _loc2_ = var_18.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  var_642[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_18 == null)
            {
               var_18 = new LibraryLoader(_debug);
               var_18.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,libraryLoadedHandler);
               var_18.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            }
            var_452 = param2;
            _file = param1.url;
            var_18.load(param1,param3);
         }
         return var_18;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_453.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_341[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_382[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_340.splice(var_340.indexOf(_loc2_),1);
      ...
      public function loadFromArchive(param1:URLRequest, param2:LoaderContext = null) : LibraryLoader
      {
         if(!(_file == param1.url && var_296))
         {
            ...
            var_18 = new ZipLoader(_debug);
            var_18.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,archiveLoadedHandler);
            var_18.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            var_18.addEventListener(ProgressEvent.PROGRESS,onLoadProgress);
            var_452 = true;
            _file = param1.url;
            var_18.load(param1,param2);
         }
         return var_18;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_383[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_341 != null ? false : false;
      }
   }
}
