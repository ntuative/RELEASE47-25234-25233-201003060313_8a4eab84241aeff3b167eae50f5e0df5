package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_453 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_369 + " for file \"" + var_18.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_933 > 0)
            {
               var_18.close();
               var_18.unload();
               addRequestCounterToUrlRequest(var_324,const_1402 - var_933);
               var_18.load(var_324,_context);
               --var_933;
               return true;
            }
