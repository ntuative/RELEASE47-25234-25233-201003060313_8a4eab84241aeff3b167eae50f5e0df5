package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_792:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_792.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_792.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_792.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_792.remove(param1);
         var_792.add(param1,param2);
      }
