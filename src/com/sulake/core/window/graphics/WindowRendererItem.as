package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_788:uint = 1;
      ...
      private var var_936:Matrix;
      
      private var var_141:WindowRenderer;
      
      private var var_1062:uint;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_486:
            ...
            case WindowRedrawFlag.const_844:
               var_721 = var_720.getTheActualState(param1.type,param1.style,param1.state);
               if(var_721 != var_1062)
               {
                  var_234 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_889:
               ...
               break;
            case WindowRedrawFlag.const_248:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_720.getTheActualState(param1.type,param1.style,param1.state) != var_1062;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_789) : uint(const_500);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_721) ? uint(const_788) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_788)
               {
                  ...
                  if(var_234)
                  {
                     ...
                     _loc6_.draw(param1,var_94,var_94.rect,var_721,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_94,var_936,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_720.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_851)
            {
               _loc2_ = var_720.getSkinRendererByType(param1.type,WindowStyle.const_851);
            }
         }
         return _loc2_;
      }
