package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_842:uint = 256;
      ...
      public static const const_1561:uint = 128;
      
      public static const const_1569:uint = 64;
      
      public static const const_591:uint = 4;
      
      public static const const_1220:uint = 0;
      
      public static const const_1261:uint = 16;
      
      public static const const_635:uint = 1;
      
      public static const const_1315:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_622:Boolean;
      
      protected var var_1597:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_888:
               ...
               break;
            case GraphicContext.const_1315:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1261:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_591:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_842:
               break;
            case GraphicContext.const_1220:
               break;
            default:
         ...
         if(var_622)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1597,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1597,16777215);
                  }
                  var_373 += bitmap.width * bitmap.height * 4;
               }
