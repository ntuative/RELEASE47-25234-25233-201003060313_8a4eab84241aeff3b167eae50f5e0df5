package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2338:Rectangle = new Rectangle();
      ...
      protected var var_527:String = "none";
      
      protected var var_621:Number;
      
      protected var var_368:Number;
      
      protected var _field:TextField;
      
      protected var var_752:Boolean = false;
      ...
      private static function method_6(param1:TextController, param2:Boolean) : void
      {
      ...
      {
         return new Rectangle(var_621 * maxScrollH,var_368 * maxScrollV,width,height);
      }
      ...
      {
         var_621 = param1;
         _field.scrollH = var_621 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      private function createPropertySetterTable() : Dictionary
      {
         ...
         _loc1_["display_as_password"] = method_6;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_946,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_388,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_388,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_553,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_553,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("auto_size",var_527,PropertyStruct.STRING,var_527 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_553,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_621 = var_621;
         _loc1_.var_368 = var_368;
         _loc1_.var_67 = var_67.clone(_loc1_.setTextMargins);
         _loc1_.var_527 = var_527;
         _loc1_.var_752 = var_752;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_527 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_527 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_527 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_527 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_7.x,var_7.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
