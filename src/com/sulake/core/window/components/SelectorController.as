package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      protected var var_2275:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_210)
         {
         ...
         if(param1 != null)
         {
            if(param1 != _selected)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_313,this,_selected));
               }
            }
         }
      }
