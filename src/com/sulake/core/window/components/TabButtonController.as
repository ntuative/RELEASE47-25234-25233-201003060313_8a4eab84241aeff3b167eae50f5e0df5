package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1423:String = "TAB_BUTTON_ICON";
      
      private static const const_1422:String = "TAB_BUTTON_CONTENT";
      ...
      {
         if(param2.type == WindowNotifyEvent.const_277)
         {
