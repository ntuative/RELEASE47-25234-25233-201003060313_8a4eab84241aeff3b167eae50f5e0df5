package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1095:String = "content";
      
      private static const const_1094:String = "selector";
       
      
      private var var_1222:Boolean = false;
      
      protected var var_934:ITabSelectorWindow;
      
      private var var_808:Boolean = false;
      
      protected var var_1596:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1596 == null)
         {
            var_1596 = findChildByTag(TabContextController.const_1095) as IWindowContainer;
         }
         return var_1596;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_934 == null)
         {
            var_934 = findChildByTag(TabContextController.const_1094) as ITabSelectorWindow;
            if(var_934 != null)
            {
               var_934.procedure = selectorEventProc;
            }
         }
         return var_934;
      }
      ...
      {
         return !!var_808 ? selector.iterator : null;
      }
