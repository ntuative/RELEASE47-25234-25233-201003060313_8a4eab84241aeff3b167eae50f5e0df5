package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      protected function method_14(param1:WindowEvent, param2:IWindow) : void
      {
      }
      ...
      {
         var _loc2_:IItemListWindow = _context.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_326,WindowStyle.const_321,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),method_14,null,numListItems,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IItemListWindow;
      ...
      {
         var _loc2_:* = null;
         if(param1.type == WindowEvent.const_420)
         {
