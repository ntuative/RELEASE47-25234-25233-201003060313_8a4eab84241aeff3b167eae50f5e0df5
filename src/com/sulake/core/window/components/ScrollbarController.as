package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1090:String = "increment";
      
      private static const const_493:String = "slider_bar";
      
      private static const const_1089:String = "decrement";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_493:
               if(param2.type == WindowNotifyEvent.const_263)
               {
                  if(!var_564)
                  {
                     if(_horizontal)
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_23 != null && true)
         {
            IWindow(var_23).removeEventListener(WindowEvent.const_45,onScrollableResized);
         }
         var_23 = param1;
         if(var_23 != null && true)
         {
            IWindow(var_23).addEventListener(WindowEvent.const_45,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_493) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_834 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_834 != null)
         {
            _loc1_ = findParentByName(var_834) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_834) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1090)
            {
               if(var_23)
               {
                  var_564 = true;
            ...
            else if(param2.name == ScrollbarController.const_1089)
            {
               if(var_23)
               {
                  var_564 = true;
            ...
            else if(param2.name == ScrollbarController.const_767)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_493).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_884)
         {
