package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_760:String = "margin_top";
      
      private static const const_1076:String = "_HEADER";
      
      private static const const_759:String = "margin_right";
      
      private static const const_1074:String = "_SCALER";
      ...
      private static const const_757:String = "margin_bottom";
      ...
      private var var_1189:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_758,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_759,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_757,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_251);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1189 == null)
         {
            var_1189 = findChildByTag(const_1076) as IHeaderWindow;
            if(!var_1189)
            {
      ...
      {
         return findChildByTag(const_1074) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_241,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1075) as IWindowContainer;
            if(!var_22)
            {
