package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_806:IItemListWindow;
      
      private var var_345:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_68))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_345)
         {
            var_345 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_345)
            {
               var_345.addEventListener(WindowEvent.const_273,scrollBarEventProc);
               var_345.addEventListener(WindowEvent.const_228,scrollBarEventProc);
            }
         }
         return var_345;
      }
      ...
      override public function dispose() : void
      {
         if(var_345)
         {
            var_345.removeEventListener(WindowEvent.const_273,scrollBarEventProc);
            var_345.removeEventListener(WindowEvent.const_228,scrollBarEventProc);
            var_345 = null;
         }
         if(var_806)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_228)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_806)
         {
            var_806 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_806;
      }
