package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_1590:IMouseCursor;
      
      public static const const_1555:int = 2;
      
      private static var var_952:Factory;
      
      private static var var_141:IWindowRenderer;
      
      public static var var_1366:KeyboardEventQueue;
      ...
      protected var var_2259:IWindowFactory;
      ...
      protected var var_2260:IWindowParser;
      
      protected var var_929:Error;
      
      protected var var_2258:IInternalWindowServices;
      
      protected var var_96:WindowController;
      
      protected var var_1367:int = -1;
      
      protected var var_89:IDesktopWindow;
      
      private var var_1402:Boolean = false;
      
      protected var var_2352:Boolean = true;
      
      private var var_182:Boolean = false;
      
      protected var var_1100:SubstituteParentController;
      
      private var var_2282:Point;
      
      protected var var_321:DisplayObjectContainer;
      
      private var var_333:IWindowContextStateListener;
      
      private var _name:String;
      
      protected var _localization:ICoreLocalizationManager;
      
      private var var_536:Point;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_321 = param5;
         var_2258 = new InternalWindowServices(this,param5);
         var_2259 = param3;
         var_2260 = new WindowParser(this);
         var_717 = new Date();
         if(var_952 == null)
         {
            var_952 = new Factory();
         ...
         if(var_1366 == null)
         {
            var_1366 = new KeyboardEventQueue(param5);
         }
         if(param6 == null)
         {
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_370)
         {
            param1.destroy();
         }
         return true;
      ...
      {
         var _loc12_:Class = var_952.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         var_321.removeChild(IGraphicContextHost(var_89).getGraphicContext(true) as DisplayObject);
         var_89.destroy();
         var_89 = null;
         var_1100.destroy();
         var_1100 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_89 != null && true)
         {
            if(var_321 is Stage)
            {
               var_89.width = Stage(var_321).stageWidth;
               var_89.height = Stage(var_321).stageHeight;
            }
            else
            {
               var_89.width = var_321.width;
               var_89.height = var_321.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_536.x || _loc2_.stageY != var_536.y)
            {
               var_536.x = _loc2_.stageX;
               var_536.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_89.groupChildrenUnderPoint(var_536,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_96 && true)
                     {
                        if(var_333 != null)
                        {
                           var_333.mouseEventReceived(_loc2_.type,var_96);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1590 == null)
         {
            var_1590 = new MouseCursorControl(var_321);
         }
         return var_1590;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_371))
         {
