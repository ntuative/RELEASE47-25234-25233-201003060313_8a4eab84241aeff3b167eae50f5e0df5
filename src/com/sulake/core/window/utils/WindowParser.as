package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1441:String = "_INCLUDE";
      
      public static const const_1012:String = "_EXCLUDE";
      
      public static const const_1607:String = "_TEMP";
      
      private static const const_1083:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1082:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1105:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_932:Dictionary;
      
      protected var var_1372:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1371:Dictionary;
      
      protected var var_1106:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1106 = new Dictionary();
         var_1105 = new Dictionary();
         TypeCodeTable.fillTables(var_1106,var_1105);
         var_932 = new Dictionary();
         var_1371 = new Dictionary();
         ParamCodeTable.fillTables(var_932,var_1371);
         var_1372 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1082,"");
         return param1.replace(const_1083,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1106)
            {
               delete var_1106[_loc1_];
            }
            for(_loc1_ in var_1105)
            {
               delete var_1105[_loc1_];
            }
            for(_loc1_ in var_932)
            {
               delete var_932[_loc1_];
            }
            for(_loc1_ in var_1371)
            {
               delete var_1371[_loc1_];
            }
            var_1372.dispose();
            var_1372 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1012) == -1)
                  {
