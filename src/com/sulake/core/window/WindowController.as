package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_17)
         {
            var_17 = getGraphicContext(!testParamFlag(WindowParam.const_32));
         }
         ...
         if(_loc12_ != null)
         {
            var_367 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_56 = var_367.clone();
            var_7 = var_367.clone();
         ...
         if(param7 != null)
         {
            ...
            if(var_17)
            {
               _context.invalidate(this,var_7,WindowRedrawFlag.const_76);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_158);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_267)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_316)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         var_750 = param1;
         var_619 = !!var_750 ? uint(var_619 | var_1369) : uint(var_619 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1703 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_992:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1359:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1250:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_995:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_859:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_719:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_210:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_801:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_263:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_409:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_322:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_467:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_277:
               _loc2_ = "null";
         }
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_857,this,null);
         update(this,_loc1_);
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_992;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_635,var_7);
            var_17.visible = var_331;
         }
         return var_17;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_7,WindowRedrawFlag.const_889);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_959 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_322,this,param1));
         return param1;
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_145 != null)
         {
            param4.x = var_145.x;
            param4.y = var_145.y;
            param4.width = var_145.width;
            param4.height = var_145.height;
         }
      }
      ...
      {
         return !testParamFlag(WindowParam.const_32) || var_17 != null;
      }
      ...
      {
         var_1369 = param1 & 4278190080;
         var_619 = !!var_750 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_7,WindowRedrawFlag.const_76);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_525))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1002;
                  if(testParamFlag(WindowParam.const_330))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_225))
                        {
                  ...
                  if((var_16 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_251))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_251))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            ...
            {
               case WindowNotifyEvent.const_227:
                  _context.invalidate(this,var_7.union(var_56),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_467,this,null));
                     if(testParamFlag(WindowParam.const_163,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_166,WindowParam.const_158))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        _loc8_ = uint(var_16);
                        var_16 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_364))
                        {
                           var_8.width += 0 - 0;
                        }
                        ...
                        var_16 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_277,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_373:
                  _context.invalidate(this,var_7.union(var_56),WindowRedrawFlag.const_486);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_801,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_263,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_309:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_719,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_210,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_442:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_844);
                  break;
               case WindowNotifyEvent.const_358:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_390:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_486);
                     }
                  }
                  else if(var_16 & 0)
                  {
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_802;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_543;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_959 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_394)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_16 & 0);
            if(_loc7_ == WindowParam.const_415)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_396)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_975,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_571,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               var_56.x = var_7.x;
               var_56.y = var_7.y;
               var_56.width = var_7.width;
               var_56.height = var_7.height;
               var_7.x = param1;
               var_7.y = param2;
            }
            if(_loc6_)
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_227,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1291,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_162 && var_751 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1423,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1423,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_76);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1161,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_63,false);
         _loc1_.type = WindowNotifyEvent.const_1221;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               ...
               var_56.width = var_7.width;
               var_56.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_409,this,var_8));
            }
            else
            {
               var_295.x = 0;
               ...
               var_295.width = 0;
               var_295.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_966,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_16,_context,var_7,null,var_620,properties,var_618.concat(),_id) as WindowController;
         _loc2_.var_751 = var_751;
         _loc2_.var_162 = var_162;
         _loc2_._debug = _debug;
         _loc2_.var_295 = var_295.clone();
         _loc2_.var_7 = var_7.clone();
         _loc2_.var_367 = var_367.clone();
         ...
         _loc2_.var_1369 = var_1369;
         _loc2_.var_1101 = var_1101;
         _loc2_.var_331 = var_331;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_510;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_430;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_145.x = param3.x;
            var_145.y = param3.y;
            var_145.width = param3.width;
            var_145.height = param3.height;
         }
         if(param2 != null)
         {
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_859;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_37 == WindowState.const_370)
         {
            return true;
         }
         var_37 = WindowState.const_370;
