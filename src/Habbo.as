package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_9:String = "client.init.start";
      
      public static const const_10:String = "debug";
      ...
      public static const const_16:String = "error_data";
      
      public static const const_7:String = "flash_version";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_7] = Capabilities.version;
            _loc6_[const_15] = 0;
            _loc6_[const_12] = param1;
            _loc6_[const_14] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_16] = String(param3.getStackTrace());
            }
            _loc6_[const_10] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
