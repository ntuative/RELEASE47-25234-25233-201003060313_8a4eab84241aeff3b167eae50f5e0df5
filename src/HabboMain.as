package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_35.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_818);
      ...
      private function initializeCore() : void
      {
         ...
         {
            trackLoginStep(Habbo.const_26);
            Core.crash("Failed to initialize the core: " + error.message,Core.const_931,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            trackLoginStep(Habbo.const_26);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_931,error);
            Core.dispose();
         }
      }
